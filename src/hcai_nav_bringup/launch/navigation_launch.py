...
def generate_launch_description() -> LaunchDescription:
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(hcai_nav_bringup_dir, 'config', 'nav2_params.yaml'),
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map',
        default_value=os.path.join(hcai_nav_bringup_dir, 'maps', 'empty.yaml'),
